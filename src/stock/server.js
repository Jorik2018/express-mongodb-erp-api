...
//GET /product_types
app.get('/product_types', (req:any, res:any) => {
  connection.query(`
...
//GET /products/{id}
app.get('/products/:product_id', (req:any, res:any) => {
...
app.get('/product_types/:product_type_id', (req:any, res:any) => {
  connection.query(`
      SELECT db.product_types.*, db.departments.dept_name, COUNT(db.products.product_id) AS in_stock
      FROM db.product_types 
        INNER JOIN db.departments ON db.product_types.dept_id = db.departments.dept_id
...
//GET /departments/{id}
app.get('/departments/:dept_id', (req:any, res:any) => {
...
//GET /orders/{id}
app.get('/orders/:order_id', (req:any, res:any) => {
...
//GET /sales/{id}
app.get('/sales/:sale_id', (req:any, res:any) => {
...
//GET /users/{id}
app.get('/users/:user_id', (req:any, res:any) => {
...
//DELETE /products/{id}
app.delete('/products/:product_id', (req:any, res:any) => {
...
app.delete('/product_types/:product_type_id', (req:any, res:any) => {
...
app.delete('/departments/:dept_id', (req:any, res:any) => {
...
//DELETE /orders/{id}
app.delete('/orders/:order_id', (req:any, res:any) => {
...
//DELETE /sales/{id}
app.delete('/sales/:sale_id', (req:any, res:any) => {
...
//DELETE /users/{id}
app.delete('/users/:user_id', (req:any, res:any) => {
...
app.get('/product_types/:product_type_id/quantity', (req:any, res:any) => {
  console.log(req.body);
...
app.get('/users/department/:dept_id', (req:any, res:any) => {
  console.log(req.body);
...
app.get('/product_types/name/:product_type_name', (req:any, res:any) => {
  console.log(req.body);
...
app.get('/product_types/department/:dept_id', (req:any, res:any) => {
  console.log(req.body);
...
app.get('/products/product_type/:product_type_id', (req:any, res:any) => {
  console.log(req.body);
...
app.get('/products/sale/:sale_id', (req:any, res:any) => {
  console.log(req.body);
